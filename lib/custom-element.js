...
export default class ElementBuilder {
  ...
  attributes(attributes) {
    const observedAttributes = /** @type {(keyof ObservedAttributes<A>)[]} */(Object.entries(attributes).filter(([, v]) => v.observe).map(([k]) => k));
    ...
    return new this.builderClass(AttributesElement);
  }
  ...
  shadow(init = {}) {
    ...
    return new this.builderClass(ShadowElement);
  }
  ...
  formAssociated() {
    ...
    return new this.builderClass(FormAssociatedElement);
  }
  ...
  internals(aria = {}) {
    ...
    return new this.builderClass(InternalsElement);
  }
  ...
  tag(name) {
    ...
    return new this.builderClass(NamedElement);
  }
